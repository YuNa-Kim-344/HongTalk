...
public class Canvas {
	...
	public Canvas() {
		JFrame f = new JFrame("홍톡 2.0 그림판");
...
class RectPanel extends JPanel implements ActionListener, MouseListener, MouseMotionListener {
	...
	JComboBox<Float> strokeComboBox; // setStroke에서 받는 인자 자료형이 float
	...
	private void sendImageToServer(BufferedImage image) {
        try {
            // 이미지를 SerializableImage로 감싸고 ObjectOutputStream을 통해 서버로 전송
	...
	public void updatePaint() {
	 ...
	 public void setImage(BufferedImage image) {
	    ...
	    // 이미지를 받아서 화면에 표시하는 paintComponent 메서드 추가
